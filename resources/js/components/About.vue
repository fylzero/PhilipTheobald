<template>
    <div class="limit-width center pb-100 pink-links">
        <div class="text-center">
            <picture>
                <source type="image/webp" srcset="/img/webp/me.webp" />
                <img src="/img/jpg/me.jpg" alt="Me" class="rounded" />
            </picture>
        </div>
