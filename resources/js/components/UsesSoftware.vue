<template>
    <div>
        ...
        <h2>Code Editor</h2>
        <p>These days I am rocking <a href="https://code.visualstudio.com/" target="blank">VS Code (Visual Studio Code)</a>.  Everyone else switched to it, so I hopped on the bandwagon.  ¯\_(ツ)_/¯<br><br>I used to be a big Sublime Text user for many years, wound up switching to Atom for a bit, now I'm all about that VS Code life.</p>
        <div class="text-center">
            <picture>
                <source type="image/webp" srcset="/img/webp/vs-code.webp" />
                <img src="/img/png/vs-code.png" alt="VS Code Editor" class="rounded" style="width: 100%; height: auto;" />
            </picture>
        </div>
        ...
        <div class="text-center">
            <picture>
                <source type="image/webp" srcset="/img/webp/iterm.webp" />
                <img src="/img/png/iterm.png" alt="iTerm2 Terminal" class="rounded" style="width: 100%; height: auto;" />
            </picture>
        </div>
