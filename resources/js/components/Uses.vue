<template>
    <div class="limit-width center pb-100 pink-links">
        ...
        <h2>Backpack</h2>
        <p>Ogio Renegade RSS Backpack</p>
        <div class="text-center">
            <picture>
        ...
        <h2>Messenger Bag</h2>
        <p>Crumpler Skivvy (M) Messenger Laptop Bag - Orange</p>
        <div class="text-center">
            <picture>
        ...
        <h2>Terminal</h2>
        <p>iTerm2 is my terminal of choice.  I use OhMyZsh with the Agnoster config found <a href="https://medium.com/swlh/power-up-your-terminal-using-oh-my-zsh-iterm2-c5a03f73a9fb" target="blank">here</a>.</p>
        <div class="text-center">
            <picture>
